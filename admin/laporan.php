			...
			<div class="container-fluid">
						...
						<?php
							if(isset($_GET['submit'])){
								...
								$tipe    = $_GET['tipe'];
								$stt	 = "Sudah Dibayar";
								$sqlsewa = "SELECT booking.*,mobil.*,merek.*,users.* FROM booking
											JOIN mobil ON booking.id_mobil=mobil.id_mobil
											JOIN merek ON mobil.id_merek=merek.id_merek
											JOIN users ON users.email=booking.email
											WHERE booking.status='$stt' AND booking.tgl_booking BETWEEN '$mulai' AND '$selesai'";
								if (!empty($tipe)) {
									$sqlsewa .= " AND mobil.id_merek='$tipe'";
								}
						...
						<div class="panel panel-default">
							...
							<div class="form-group">
									<a href="laporan_cetak.php?awal=<?php echo $mulai;?>&akhir=<?php echo $selesai;?>&tipe=<?php echo $tipe;?>" target="_blank" class="btn btn-primary">Cetak</a>
							</div>
						<?php }?>
